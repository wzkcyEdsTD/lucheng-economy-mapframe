...
const CONFIG_OUTSIDE = {
  ARCGIS_API_URL:
    "http://lysb.lucheng.gov.cn/lc/libs/arcgis_js_v412_api/arcgis_js_api/library/4.12/dojo/dojo.js",
  LOCAL_DOMAIN: "http://jjdtgis.lucheng.gov.cn",
  LOCAL_HOST: "http://jjdtgis.lucheng.gov.cn/arcgis/rest/services",
  FORWARD_HOST: "http://jjdtgis.lucheng.gov.cn/arcgis/rest/services",
  OTHER_HOST: "https://services.wzmap.gov.cn/server/rest/services",
  SERVER_HOST: "http://lysb.lucheng.gov.cn/s/lc",
  API_HOST: "http://lysb.lucheng.gov.cn",
  LOGIN_HOST: " http://lysb.lucheng.gov.cn"
};
const TO_CONFIG =
...
//  公房        [0.公房点 1.房屋面]
export const GONGFANG = `${FORWARD_HOST}/lcjjdt/gongfang/MapServer`;
/******** ********/
//  底图
export const IMAGELAYER =
  window.env == "outside" || window.env == "dev"
    ? `${OTHER_HOST}/Hosted/DSJ/VectorTileServer`
    : `${LOCAL_HOST}/Hosted/kfq_WGS84/VectorTileServer`;
// mapbox底图
export const MAPBOXLAYER = `${FORWARD_HOST}/lcjjdt/lcdt/MapServer`;
//  三维-白模房屋面
